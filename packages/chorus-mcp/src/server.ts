 ...
 *     claude mcp add cwi -- node /path/to/packages/chorus-mcp/dist/server.js
 */
...
} from 'chorus-captions';
import { startPreview, type PreviewHandle } from 'chorus-captions/preview';
import { render, PRESETS } from 'chorus-captions/render';
import { deliver, TARGETS } from 'chorus-captions/deliver';
import { conform } from 'chorus-captions/conform';
import { checkReport, loadScene, loadScenes,
  type RenderReport, type RenderConformResult } from 'chorus-captions/render-conform';
import { probeWebRenderer } from 'chorus-captions/render-probe';
import { audit } from 'chorus-captions/audit';
import { toHtml, toMarkdown } from 'chorus-captions/audit-report';
import { init } from 'chorus-captions/scaffold';
